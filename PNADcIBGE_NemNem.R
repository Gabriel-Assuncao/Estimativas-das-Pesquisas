...
# Criando variável de condição de ocupação e estudo
{
  if(ano < 2019)
  {
    pnadc_anual_trimestre$variables <- transform(pnadc_anual_trimestre$variables, condicao_ocupacao_estudo=as.factor(ifelse((VD4001=="Pessoas na força de trabalho" & VD4002=="Pessoas ocupadas") & (MV3002=="Sim" | MV3019=="Sim" | MV3024=="Sim" | MV3026=="Sim"),"Ocupadas e frequentando escola, cursos pré-vestibular, técnico de nível médio, normal (magistério) ou qualificação profissional",
                                                                                                                            ifelse((VD4001=="Pessoas na força de trabalho" & VD4002=="Pessoas ocupadas") & (MV3002=="Não" & MV3019!="Sim" & MV3024!="Sim" & MV3026!="Sim"),"Ocupadas e não frequentando escola, nem cursos pré-vestibular, técnico de nível médio, normal (magistério) ou qualificação profissional",
                                                                                                                                   ifelse(((VD4001=="Pessoas na força de trabalho" & VD4002=="Pessoas desocupadas") | VD4001=="Pessoas fora da força de trabalho") & (MV3002=="Sim" | MV3019=="Sim" | MV3024=="Sim" | MV3026=="Sim"),"Não ocupadas e frequentando escola, cursos pré-vestibular, técnico de nível médio, normal (magistério) ou qualificação profissional",
                                                                                                                                          ifelse(((VD4001=="Pessoas na força de trabalho" & VD4002=="Pessoas desocupadas") | VD4001=="Pessoas fora da força de trabalho") & (MV3002=="Não" & MV3019!="Sim" & MV3024!="Sim" & MV3026!="Sim"),"Não ocupadas e não frequentando escola, nem cursos pré-vestibular, técnico de nível médio, normal (magistério) ou qualificação profissional",NA))))))
  }
  else
  {
    pnadc_anual_trimestre$variables <- transform(pnadc_anual_trimestre$variables, condicao_ocupacao_estudo=as.factor(ifelse((VD4001=="Pessoas na força de trabalho" & VD4002=="Pessoas ocupadas") & (MV3002=="Sim" | (MV3019A=="Sim, curso técnico de nível médio" | MV3019A=="Sim, curso normal (magistério)") | MV3024=="Sim" | MV3026=="Sim"),"Ocupadas e frequentando escola, cursos pré-vestibular, técnico de nível médio, normal (magistério) ou qualificação profissional",
                                                                                                                            ifelse((VD4001=="Pessoas na força de trabalho" & VD4002=="Pessoas ocupadas") & (MV3002=="Não" & (MV3019A!="Sim, curso técnico de nível médio" & MV3019A!="Sim, curso normal (magistério)") & MV3024!="Sim" & MV3026!="Sim"),"Ocupadas e não frequentando escola, nem cursos pré-vestibular, técnico de nível médio, normal (magistério) ou qualificação profissional",
                                                                                                                                   ifelse(((VD4001=="Pessoas na força de trabalho" & VD4002=="Pessoas desocupadas") | VD4001=="Pessoas fora da força de trabalho") & (MV3002=="Sim" | (MV3019A=="Sim, curso técnico de nível médio" | MV3019A=="Sim, curso normal (magistério)") | MV3024=="Sim" | MV3026=="Sim"),"Não ocupadas e frequentando escola, cursos pré-vestibular, técnico de nível médio, normal (magistério) ou qualificação profissional",
                                                                                                                                          ifelse(((VD4001=="Pessoas na força de trabalho" & VD4002=="Pessoas desocupadas") | VD4001=="Pessoas fora da força de trabalho") & (MV3002=="Não" & (MV3019A!="Sim, curso técnico de nível médio" & MV3019A!="Sim, curso normal (magistério)") & MV3024!="Sim" & MV3026!="Sim"),"Não ocupadas e não frequentando escola, nem cursos pré-vestibular, técnico de nível médio, normal (magistério) ou qualificação profissional",NA))))))
  }
}
