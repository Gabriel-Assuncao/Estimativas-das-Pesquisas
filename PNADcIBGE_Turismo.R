...
print(x=domicilios_viagens <- svybys(formula=~as.integer(domicilios=="Total")+ocorrencia_viagens, bys=~Pais+GR+UF, design=subset(pnadc_anual_turismo, V2005=="Pessoa responsável pelo domicílio"), FUN=svytotal, vartype=c("se","cv"), keep.names=FALSE, na.rm=TRUE))
...
print(x=viagens_realizadas <- svybys(formula=~viagens, bys=~Pais+GR+UF, design=subset(pnadc_anual_turismo, V2005=="Pessoa responsável pelo domicílio" & S08001=="Sim"), FUN=svytotal, vartype=c("se","cv"), keep.names=FALSE, na.rm=TRUE))
...
print(x=viagens_nacionais <- svybys(formula=~nacionais, bys=~Pais+GR+UF, design=subset(pnadc_anual_turismo, V2005=="Pessoa responsável pelo domicílio" & S08001=="Sim"), FUN=svytotal, vartype=c("se","cv"), keep.names=FALSE, na.rm=TRUE))
...
print(x=viagens_pernoites <- svybys(formula=~pernoites, bys=~Pais+GR+UF, design=subset(pnadc_anual_turismo, V2005=="Pessoa responsável pelo domicílio" & S08001=="Sim"), FUN=svytotal, vartype=c("se","cv"), keep.names=FALSE, na.rm=TRUE))
...
print(x=viagens_nacionais_pernoites <- svybys(formula=~nacionais_pernoites, bys=~Pais+GR+UF, design=subset(pnadc_anual_turismo, V2005=="Pessoa responsável pelo domicílio" & S08001=="Sim"), FUN=svytotal, vartype=c("se","cv"), keep.names=FALSE, na.rm=TRUE))
